...
<table border="0" cellspacing="1"  id="STable" style="width:800px;">
	...
	<tr>
	<td class="td_block">
	<form action="index.php?c=index&a=backup&category=backup_now" method="POST"  id="backup_now" />
	...
	添加备注:<br />
	<input type="text" class="input_text" name="backup_comment" value="<?php echo isset($_POST['backup_comment']) ? $_POST['backup_comment'] : '';?>" /> (可不填写) <br /> 
