...
class module extends AmysqlController
{
	...
	function module_list()
	{
		...
		{
			echo file_get_contents("http://amysql.com/AMH.htm?module_fraction={$_GET['fraction']}&val={$_GET['val']}");
			exit();
		}
	...
	function module_down()
	{
		...
		$page_list = Functions::page('NewModuleList', $new_module_list['sum'], $total_page, $page, 'c=module&a=module_down');		// 分页列表
