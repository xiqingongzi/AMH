...
<div id="module_list" style="position: relative">
	...
	?>
		<div class="item">
			...
			<a class="stars"  href="javascript:;" name="<?php echo $val['AMH-ModuleName'];?>" title="得分<?php echo $val['AMH-ModuleFraction']['val'];?> 总<?php echo $val['AMH-ModuleFraction']['sum'];?>次评价">
				<font class="stars_val" name="<?php echo $val['AMH-ModuleFraction']['val'];?>" style="width:<?php echo $val['AMH-ModuleFraction']['val'];?>px;display:block;margin:0px;">
				</font>
				<span></span>
			</a>
			</div>
