...
<a href="index.php?c=index&a=host" id="host" >Host</a>
<a href="index.php?c=index&a=mysql" id="mysql" >MySQL</a>
<a href="index.php?c=index&a=ftp" id="ftp" >FTP</a>
<a href="index.php?c=index&a=backup" id="backup" >Backup</a>
<a href="index.php?c=index&a=task" id="task" >Task</a>
<a href="index.php?c=index&a=account" id="account" >Account</a>
