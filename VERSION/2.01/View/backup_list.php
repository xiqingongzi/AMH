...
<table border="0" cellspacing="1"  id="STable" style="width:900px;">
	...
	{
	?>
		<tr><td colspan="8">暂无备份数据记录.</td></tr>
	<?php	
	}
	else
	{
	...
	?>
			...
			<td>
			<a href="index.php?c=index&a=backup&category=backup_revert&revert_id=<?php echo $val['backup_id'];?>" class="button" ><span class="reload icon"></span>一键还原</a>
			<a href="index.php?c=index&a=backup&category=backup_list&del=<?php echo $val['backup_id'];?>" class="button" onclick="return confirm('确认删除备份数据:<?php echo $val['backup_file'];?>?');"><span class="cross icon"></span>删除</a>
			</td>
			</tr>
	<?php
		}
