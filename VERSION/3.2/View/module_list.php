...
<div id="module_list">
	...
	?>
		<div class="item"  onmouseover="this.className='item_hover'" onmouseout="this.className='item'">
			...
			<a class="button" href="./index.php?c=module&a=module_list&name=<?php echo $val['AMH-ModuleName'];?>&action=<?php echo $val['AMH-ModuleAction'];?>&page=<?php echo $page;?>&actionName=<?php echo urlencode($val['AMH-ModuleButton']);?>" onclick="return (confirm('确认<?php echo $val['AMH-ModuleButton'];?><?php echo $val['AMH-ModuleName'];?>吗?') && (this.innerHTML='Loading...'))" ><?php echo $val['AMH-ModuleButton'];?></a>
			<?php }?>
