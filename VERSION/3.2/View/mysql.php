...
<table border="0" cellspacing="1"  id="STable" style="width:500px;margin-bottom:5px;">
	...
	<td><a href="index.php?c=mysql&a=mysql_list&ams=database&name=<?php echo urlencode($val['Database']);?>" target="_blank"><?php echo $val['Database'];?></a></td>
...
<input type="button" value="MySQL管理" onclick="window.open('index.php?c=mysql&a=mysql_list&ams=index');"/>
<input type="button" value="创建数据库" onclick="window.open('index.php?c=mysql&a=mysql_list&ams=create');"/>
