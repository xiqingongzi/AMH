...
<table border="0" cellspacing="1"  id="STable" style="width:auto;min-width: 700px;">
	...
	?>
			...
			<a href="index.php?c=ftp&a=ftp_list&chown=<?php echo $val['ftp_name'];?>&uidname=<?php echo $val['ftp_uid_name'];?>" class="button"  onclick="return confirm('确认递归重写目录:<?php echo $val['ftp_root'];?>\n\n为FTP账号的<?php echo $val['ftp_uid_name'];?>用户权限吗?');"><span class="key icon"></span> 重写目录权限</a>
